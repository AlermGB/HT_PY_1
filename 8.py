...
bar_lenght = int(input('How many slices are in the length of your chocolate bar? '))
bar_width = int(input('How many slices are in the width of your chocolate bar? '))
